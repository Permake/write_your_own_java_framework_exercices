...
public class AnnotationScannerTest {
   ...
   * var textPath = Files.writeString(folder.resolve("text.txt"),
   * "this is a text");
   * var javaPath = Files.writeString(folder.resolve("AFakeJava.class"),
   * "this is a fake java class");
   * try {
   * 
   * List<String> list;
   ...
   * AnnotationScanner.findAllClasses(packageName, classLoader));
   * }
   * } // end of Q2
   * 
   * @Nested
   ...
   * scanner.addAction(Hello.class, null)),
   * () -> assertThrows(NullPointerException.class, () -> scanner.addAction(null,
   * __ -> {}))
   * );
   * }
   * } // end of Q3
   ...
   * var scanner = new AnnotationScanner();
   * scanner.addAction(Entity.class, type -> assertEquals(AnnotatedClass.class,
   * type));
   ...
   * 
   * @Inject
   * public EntityWithANonAnnotatedDependency(NonAnnotatedDependency
   * nonAnnotatedDependency) {
   ...
   * scanner.scanClassPathPackageForAnnotations(Q4.class);
   * assertThrows(IllegalStateException.class, () ->
   * registry.lookupInstance(EntityWithANonAnnotatedDependency.class));
   * }
   * 
   * @Test @Tag("Q4")
   ...
   * var scanner = new AnnotationScanner();
   * assertThrows(NullPointerException.class, () ->
   * scanner.scanClassPathPackageForAnnotations(null));
   * }
   * 
   * } // end of Q4
   */
